...
int main(int argc, char **argv)
{
	...
	//Anthony note:
	// Just gets the version number of the kernel
    ...
    // Anthony note:
    // This is defined in ../common/opencl_util.h
    // also, it just checks to see if version number is a multiple of 2.
